...
The method itself ships in the SDK as `wai.methods.Swarm`, with
`Swarm.calibration` for the pre-flight check; `run.py` keeps its own
frozen copy so these numbers reproduce exactly.
