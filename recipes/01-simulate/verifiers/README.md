...
from run import MATH_ROWS as rows  # k rollouts per prompt, each with privileged.reference
...
`MathEqual` decides with [Math-Verify](https://github.com/huggingface/Math-Verify)
