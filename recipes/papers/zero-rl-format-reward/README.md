...
| Pinned: seed, torch, transformers, trl, peft, vllm | [the contract](../README.md#the-contract) | `--train-seeds 17` in the trainer (a comma list runs several), `--seed 0` for the data split; torch 2.13.0, transformers 5.17.0, trl 1.13.0, peft 0.21.0, vllm 0.29.0, whileai 0.83 |
