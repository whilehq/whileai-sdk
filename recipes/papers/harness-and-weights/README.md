...
[`../meta-harness`](../meta-harness) (ledger, proposal, gate [6]). The
...
coding agent running [`skills/harness-search`](../../../skills/harness-search):
...
| Pinned: seed, torch, transformers, trl, peft, vllm | [the contract](../README.md#the-contract) | seed 0, train seed 17; torch 2.13.0, transformers 5.17.0, trl 1.13.0, peft 0.21.0, vllm 0.29.0 |
