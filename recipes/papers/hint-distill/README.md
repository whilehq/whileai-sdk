...
1. Base: `Qwen/Qwen3-4B`, thinking on. Data: the text-to-SQL shop of [`../../04-train/text-to-sql`](../../04-train/text-to-sql), the first 480 train tasks and the first 120 held out by a hash of the task id (the split of its `train_grpo_modal.py --limit 480`).
...
| Pinned: seed, torch, transformers, peft, vllm | [the contract](../README.md#the-contract) | seed 17, torch 2.7.1, transformers 4.54.0, peft 0.16.0, vllm 0.10.0 |
