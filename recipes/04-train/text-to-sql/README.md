...
step-25/50 and r2 step-25 rows, correctly served, are being re-run one at
a time (a first attempt ran two eval jobs against one serve app and mixed
adapters in one file; those rows were discarded). Round 2 stays stopped: its log showed 60-88% of
