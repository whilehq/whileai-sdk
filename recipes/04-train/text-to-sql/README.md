...
| Qwen3.5-9B **r2, step 25** (from r1 step 75; truncation scored 0, 3,072 cap) | 0.55 (0.52..0.59) | 0.29 | 0.77 | 0.11 | 0.17 | 19% |
...
Round 2, step 25: 0.55, +0.019 (95% -0.007..+0.043) vs base and +0.007
(-0.018..+0.032) vs the round-1 step-75 checkpoint it started from. Flat.
Scoring cut-off replies zero did not shrink them either: 19% of holdout
replies still hit the 4,096 budget (21% before). Twenty-five steps of a
penalty the policy sees only on the runaway fifth was not enough to move
the length mode; step 50 will say whether it moves at all.
