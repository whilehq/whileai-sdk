...
[`recipes/04-train/grpo`](../grpo): the refund assistant with one testable rule.
...
uv run sh recipes/04-train/dpo/smoke.sh                             # free: prompts, split, the pairs and their report; no key, no GPU
