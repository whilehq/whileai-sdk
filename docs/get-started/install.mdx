...
`.claude/skills/` (`strengthen-your-evals`, `manage-experiments`,
`whileai-simulations`, `audit-your-judge`, `pick-a-method`), and runs the evals skill's `check.py` so the agent sees
